...
def run_program(raw_data_directory, skiprows_rawdata, study_name,
                          assesment, trim_type, sleep_diary_directory, sleep_analysis_path):
    ...
    protocol = ps.ProtocolSleepAnalysis(sleep_analysis_path, participant_list, study_name, assesment)
