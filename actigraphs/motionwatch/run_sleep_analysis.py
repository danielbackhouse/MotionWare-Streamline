...
plt.figure('Bland Altman Plot Fragmentation Index (BT Baseline)')
...
plt.figure('Correlation Between Program and Protocol')
...
plt.figure('Bland Altman Plot Sleep Effeciency (BT Baseline)')
...
plt.figure('Bland Altman Plot Actual Sleep Time (BT Baseline)')
...
plt.figure('Bland Altman Plot Sleep Latency (BT Baseline)')
