...
input_label.config(font  = font, pady = 0)
input_label.grid(row = 1, column = 0, columnspan = 3, rowspan = 1)

output_label = Label(window, text = 'Output')
font = ('helvetica', 20, 'bold')
output_label.config(font  = font, pady = 0)
output_label.grid(row = 1, column = 3, columnspan = 3, rowspan = 1)

canvas = Canvas(height = 1, width = 1000)
canvas.create_line(100, 2, 400, 2)
canvas.create_line(600, 2, 900, 2)
...
raw_data_label.grid(row = 3, column = 0, columnspan = 3)
raw_data_entry.grid(row = 4, column = 0, columnspan = 2)
openFileButton.grid(row = 4, column = 2)
...
sleep_diary_label.grid(row = 5, column = 0, columnspan = 3)
