...
rawDataDirectory = r'C:\Users\dbackhou\Desktop\Buying Time Study Copy\RAW data\Baseline\BT-001_Baseline.xlsx'

sleepDiary  = pd.read_excel(sleepDiaryDirectory, sheet_name = 'BT_001')
